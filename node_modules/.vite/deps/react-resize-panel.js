...
// node_modules/react-resize-panel/dist/index.esm.js
...
var reactIs_development = createCommonjsModule(function(module, exports) {
  if (true) {
    (function() {
      ...
      {
        var printWarning2 = function(format) {
...
var getPrefix_1 = createCommonjsModule(function(module, exports) {
  ...
  function getPrefix(prop = "transform") {
    if (typeof window === "undefined" || typeof window.document === "undefined")
      return "";
    const style2 = window.document.documentElement.style;
    if (prop in style2)
      return "";
...
var domFns = createCommonjsModule(function(module, exports) {
  ...
  exports.addEvent = addEvent2;
  exports.removeEvent = removeEvent2;
  ...
  function matchesSelector(el, selector) {
    ...
    if (!(0, shims.isFunction)(el[matchesSelectorFunc]))
      return false;
  ...
  function addEvent2(el, event, handler) {
    if (!el) {
      return;
    }
    if (el.attachEvent) {
  ...
  function removeEvent2(el, event, handler) {
    if (!el) {
      return;
    }
    if (el.detachEvent) {
...
var positionFns = createCommonjsModule(function(module, exports) {
  ...
  var _reactDom = _interopRequireDefault(import_react_dom.default);
  ...
  function getBoundPosition(draggable, x, y) {
    ...
    if (typeof bounds === "string") {
      ...
      const nodeStyle = ownerWindow.getComputedStyle(node2);
      const boundNodeStyle = ownerWindow.getComputedStyle(boundNode);
      bounds = {
        left: -node2.offsetLeft + (0, shims.int)(boundNodeStyle.paddingLeft) + (0, shims.int)(nodeStyle.marginLeft),
        top: -node2.offsetTop + (0, shims.int)(boundNodeStyle.paddingTop) + (0, shims.int)(nodeStyle.marginTop),
        right: (0, domFns.innerWidth)(boundNode) - (0, domFns.outerWidth)(node2) - node2.offsetLeft + (0, shims.int)(boundNodeStyle.paddingRight) - (0, shims.int)(nodeStyle.marginRight),
        bottom: (0, domFns.innerHeight)(boundNode) - (0, domFns.outerHeight)(node2) - node2.offsetTop + (0, shims.int)(boundNodeStyle.paddingBottom) - (0, shims.int)(nodeStyle.marginBottom)
      };
    }
    if ((0, shims.isNum)(bounds.right))
      x = Math.min(x, bounds.right);
    if ((0, shims.isNum)(bounds.bottom))
      y = Math.min(y, bounds.bottom);
    if ((0, shims.isNum)(bounds.left))
      x = Math.max(x, bounds.left);
    if ((0, shims.isNum)(bounds.top))
  ...
  function findDOMNode(draggable) {
    const node2 = _reactDom.default.findDOMNode(draggable);
    if (!node2) {
...
var DraggableCore_1 = createCommonjsModule(function(module, exports) {
  ...
  exports.default = void 0;
  var _react = _interopRequireDefault(import_react.default);
  ...
  class DraggableCore2 extends _react.default.Component {
    constructor(...args) {
      super(...args);
      ...
      _defineProperty2(this, "handleDragStart", (e) => {
        ...
        if (this.props.enableUserSelectHack)
          (0, domFns.addUserSelectStyles)(ownerDocument);
        this.setState({
          dragging: true,
          lastX: x,
          lastY: y
      ...
      _defineProperty2(this, "handleDragStop", (e) => {
        ...
        if (thisNode) {
          if (this.props.enableUserSelectHack)
            (0, domFns.removeUserSelectStyles)(thisNode.ownerDocument);
        }
    ...
    componentWillUnmount() {
      ...
      if (thisNode) {
        ...
        if (this.props.enableUserSelectHack)
          (0, domFns.removeUserSelectStyles)(ownerDocument);
      }
    }
    render() {
...
var Draggable_1 = createCommonjsModule(function(module, exports) {
  ...
  class Draggable2 extends _react.default.Component {
    // React 16.3+
    // Arity (props, state)
    ...
    constructor(props) {
      ...
      _defineProperty2(this, "onDragStart", (e, coreData) => {
        ...
        const shouldStart = this.props.onStart(e, (0, positionFns.createDraggableData)(this, coreData));
    ...
    render() {
      ...
      if (this.state.isElementSVG) {
        ...
        style2 = (0, domFns.createCSSTransform)(transformOpts, positionOffset);
      }
      const className = (0, _classnames.default)(children.props.className || "", defaultClassName, {
        [defaultClassNameDragging]: this.state.dragging,
        [defaultClassNameDragged]: this.state.dragged
      });
      return _react.default.createElement(_DraggableCore.default, _extends2({}, draggableCoreProps, {
...
var { filter, indexOf, map, push, reverse, slice, some, splice } = Array.prototype;
var idRe = /^#[\w-]*$/;
var classRe = /^\.[\w-]*$/;
var htmlRe = /<.+>/;
var tagRe = /^\w+$/;
...
var Cash = class _Cash {
  ...
  init(selector, context) {
    return new _Cash(selector, context);
  }
};
...
Cash.prototype.map = function(callback) {
  return cash(map.call(this, (ele2, i2) => callback.call(ele2, i2, ele2)));
};
...
function each(arr, callback) {
  for (let i2 = 0, l = arr.length; i2 < l; i2++) {
    if (callback.call(arr[i2], i2, arr[i2]) === false)
      break;
  }
}
cash.each = each;
...
Cash.prototype.removeProp = function(prop) {
  return this.each((i2, ele2) => {
    delete ele2[prop];
  });
};
function extend(target, ...objs) {
  const args = arguments, length = args.length;
  for (let i2 = length < 2 ? 0 : 1; i2 < length; i2++) {
    for (const key in args[i2]) {
...
cash.extend = extend;
cash.guid = 1;
function matches(ele2, selector) {
  const matches2 = ele2 && (ele2["matches"] || ele2["webkitMatchesSelector"] || ele2["mozMatchesSelector"] || ele2["msMatchesSelector"] || ele2["oMatchesSelector"]);
  return !!matches2 && matches2.call(ele2, selector);
}
cash.matches = matches;
function pluck(arr, prop, deep) {
  const plucked = [];
  for (let i2 = 0, l = arr.length; i2 < l; i2++) {
    let val2 = arr[i2][prop];
    while (val2 != null) {
      plucked.push(val2);
      if (!deep)
        break;
...
function getCompareFunction(comparator) {
  return isString(comparator) ? (i2, ele2) => matches(ele2, comparator) : isFunction(comparator) ? comparator : isCash(comparator) ? (i2, ele2) => comparator.is(ele2) : (i2, ele2) => ele2 === comparator;
}
Cash.prototype.filter = function(comparator) {
  if (!comparator)
    return cash();
  const compare = getCompareFunction(comparator);
  return cash(filter.call(this, (ele2, i2) => compare.call(ele2, i2, ele2)));
};
function filtered(collection2, comparator) {
  return !comparator || !collection2.length ? collection2 : collection2.filter(comparator);
}
...
Cash.prototype.hasClass = function(cls) {
  return cls && some.call(this, (ele2) => ele2.classList.contains(cls));
};
Cash.prototype.removeAttr = function(attr2) {
  const attrs = getSplitValues(attr2);
  if (!attrs.length)
    return this;
  return this.each((i2, ele2) => {
    each(attrs, (i3, a) => {
      ele2.removeAttribute(a);
    });
  });
};
function attr(attr2, value) {
  ...
  if (isString(attr2)) {
    if (arguments.length < 2) {
      ...
      return value2 === null ? void 0 : value2;
    }
    if (value === void 0)
      return this;
    if (value === null)
...
Cash.prototype.toggleClass = function(cls, force) {
  const classes = getSplitValues(cls), isForce = force !== void 0;
  if (!classes.length)
    return this;
  return this.each((i2, ele2) => {
    each(classes, (i3, c) => {
      if (isForce) {
        force ? ele2.classList.add(c) : ele2.classList.remove(c);
      } else {
        ele2.classList.toggle(c);
      }
    });
  });
};
...
function unique(arr) {
  return arr.length > 1 ? filter.call(arr, (item, index, self2) => indexOf.call(self2, item) === index) : arr;
}
cash.unique = unique;
Cash.prototype.add = function(selector, context) {
  return cash(unique(this.get().concat(cash(selector, context).get())));
};
function computeStyle(ele2, prop, isVariable) {
  if (!isElement(ele2) || !prop)
    return;
  const style2 = win.getComputedStyle(ele2, null);
  return prop ? isVariable ? style2.getPropertyValue(prop) || void 0 : style2[prop] : style2;
}
function computeStyleInt(ele2, prop) {
  return parseInt(computeStyle(ele2, prop), 10) || 0;
}
var cssVariableRe = /^--/;
  ...
  if (isString(prop)) {
    ...
    return this.each((i2, ele2) => {
      if (!isElement(ele2))
        return;
      if (isVariable) {
        ele2.style.setProperty(prop, value);
      } else {
        ele2.style[prop] = value;
      }
    });
  }
  for (const key in prop) {
...
function getData(ele2, key) {
  const value = ele2.dataset ? ele2.dataset[key] || ele2.dataset[camelCase(key)] : ele2.getAttribute(`data-${key}`);
  try {
...
function setData(ele2, key, value) {
  try {
    value = JSON.stringify(value);
  } catch (_a) {
  }
  if (ele2.dataset) {
    ele2.dataset[camelCase(key)] = value;
  } else {
    ele2.setAttribute(`data-${key}`, value);
  }
}
...
function data(name, value) {
  if (!name) {
    if (!this[0])
      return;
    const datas = {};
    each(this[0].attributes, (i2, attr2) => {
      const match = attr2.name.match(dataAttributeRe);
      if (!match)
        return;
  ...
  if (isString(name)) {
    ...
    return this.each((i2, ele2) => setData(ele2, name, value));
  }
...
function getExtraSpace(ele2, xAxis) {
  return computeStyleInt(ele2, `border${xAxis ? "Left" : "Top"}Width`) + computeStyleInt(ele2, `padding${xAxis ? "Left" : "Top"}`) + computeStyleInt(ele2, `padding${xAxis ? "Right" : "Bottom"}`) + computeStyleInt(ele2, `border${xAxis ? "Right" : "Bottom"}Width`);
}
...
each(["width", "height"], (index, prop) => {
  Cash.prototype[prop] = function(value) {
    ...
    return this.each((i2, ele2) => {
      if (!isElement(ele2))
        return;
      const boxSizing = computeStyle(ele2, "boxSizing");
      ele2.style[prop] = getSuffixedValue(prop, valueNumber + (boxSizing === "border-box" ? getExtraSpace(ele2, !index) : 0));
    });
  };
});
each(["Width", "Height"], (index, prop) => {
...
function getDefaultDisplay(tagName) {
  ...
  const ele2 = doc.createElement(tagName);
  doc.body.appendChild(ele2);
  const display = computeStyle(ele2, "display");
  doc.body.removeChild(ele2);
  return defaultDisplay[tagName] = display !== "none" ? display : "block";
}
function isHidden(ele2) {
  return computeStyle(ele2, "display") === "none";
}
Cash.prototype.toggle = function(force) {
  return this.each((i2, ele2) => {
    const show = force !== void 0 ? force : isHidden(ele2);
    if (show) {
      ele2.style.display = "";
      if (isHidden(ele2)) {
        ele2.style.display = getDefaultDisplay(ele2.tagName);
      }
    } else {
...
function getEventsCache(ele2) {
  return ele2[eventsNamespace] = ele2[eventsNamespace] || {};
}
function addEvent(ele2, name, namespaces, selector, callback) {
  callback.guid = callback.guid || cash.guid++;
  const eventCache = getEventsCache(ele2);
  eventCache[name] = eventCache[name] || [];
  eventCache[name].push([namespaces, selector, callback]);
  ele2.addEventListener(name, callback);
}
function parseEventName(eventName) {
  const parts = eventName.split(eventsNamespacesSeparator);
  return [parts[0], parts.slice(1).sort()];
}
function removeEvent(ele2, name, namespaces, selector, callback) {
  const cache = getEventsCache(ele2);
  if (!name) {
    for (name in cache) {
      removeEvent(ele2, name, namespaces, selector, callback);
    }
    delete ele2[eventsNamespace];
  } else if (cache[name]) {
    cache[name] = cache[name].filter(([ns, sel, cb]) => {
      if (callback && cb.guid !== callback.guid || !hasNamespaces(ns, namespaces) || selector && selector !== sel)
        return true;
      ele2.removeEventListener(name, cb);
    });
  }
}
Cash.prototype.off = function(eventFullName, selector, callback) {
  if (eventFullName === void 0) {
    this.each((i2, ele2) => removeEvent(ele2));
  } else {
    if (isFunction(selector)) {
      callback = selector;
      selector = "";
    }
    each(getSplitValues(eventFullName), (i2, eventFullName2) => {
      const [name, namespaces] = parseEventName(getEventNameBubbling(eventFullName2));
      this.each((i3, ele2) => removeEvent(ele2, name, namespaces, selector, callback));
    });
  }
  return this;
};
  ...
  each(getSplitValues(eventFullName), (i2, eventFullName2) => {
    ...
    this.each((i3, ele2) => {
      const finalCallback = function(event) {
        ...
        if (_one) {
          removeEvent(ele2, name, namespaces, selector, finalCallback);
        }
      ...
      addEvent(ele2, name, namespaces, selector, finalCallback);
    });
  });
  return this;
}
...
Cash.prototype.trigger = function(eventFullName, data2) {
  let evt;
  if (isString(eventFullName)) {
  ...
  return this.each((i2, ele2) => {
    if (isEventFocus && isFunction(ele2[evt.type])) {
      ele2[evt.type]();
    } else {
...
function getValue(ele2) {
  if (ele2.multiple && ele2.options)
    return pluck(filter.call(ele2.options, (option) => option.selected && !option.disabled && !option.parentNode.disabled), "value");
  return ele2.value || "";
}
...
Cash.prototype.serialize = function() {
  let query = "";
  this.each((i2, ele2) => {
    each(ele2.elements || [ele2], (i3, ele3) => {
      if (ele3.disabled || !ele3.name || ele3.tagName === "FIELDSET" || skippableRe.test(ele3.type) || checkableRe.test(ele3.type) && !ele3.checked)
        return;
      const value = getValue(ele3);
      if (value === void 0)
        return;
      const values = isArray(value) ? value : [value];
      each(values, (i4, value2) => {
        query += queryEncode(ele3.name, value2);
      });
    });
  });
...
function val(value) {
  ...
  return this.each((i2, ele2) => {
    if (ele2.tagName === "SELECT") {
      const eleValue = isArray(value) ? value : value === null ? [] : [value];
      each(ele2.options, (i3, option) => {
        option.selected = eleValue.indexOf(option.value) >= 0;
      });
    } else {
      ele2.value = value === null ? "" : value;
    }
  });
}
Cash.prototype.val = val;
Cash.prototype.clone = function() {
  return this.map((i2, ele2) => ele2.cloneNode(true));
};
...
Cash.prototype.children = function(comparator) {
  const result = [];
  this.each((i2, ele2) => {
    push.apply(result, ele2.children);
  });
...
Cash.prototype.contents = function() {
  const result = [];
  this.each((i2, ele2) => {
    push.apply(result, ele2.tagName === "IFRAME" ? [ele2.contentDocument] : ele2.childNodes);
  });
...
Cash.prototype.find = function(selector) {
  const result = [];
  for (let i2 = 0, l = this.length; i2 < l; i2++) {
    const found = find(selector, this[i2]);
    if (found.length) {
...
Cash.prototype.insertAfter = function(selector) {
  cash(selector).each((index, ele2) => {
    const parent = ele2.parentNode;
    if (parent) {
      this.each((i2, e) => {
        insertElement(parent, !index ? e : e.cloneNode(true), true, ele2.nextSibling);
      });
    }
  });
  return this;
...
Cash.prototype.after = function() {
  each(reverse.apply(arguments), (i2, selector) => {
...
Cash.prototype.insertBefore = function(selector) {
  cash(selector).each((index, ele2) => {
    ...
    if (parent) {
      this.each((i2, e) => {
        insertElement(parent, !index ? e : e.cloneNode(true), true, ele2);
      });
    }
  });
  return this;
...
Cash.prototype.wrap = function(selector) {
  return this.each((index, ele2) => {
    const wrapper = cash(selector)[0];
    cash(ele2).wrapAll(!index ? wrapper : wrapper.cloneNode(true));
  });
};
Cash.prototype.wrapInner = function(selector) {
  return this.each((i2, ele2) => {
    const $ele = cash(ele2), contents = $ele.contents();
    contents.length ? contents.wrapAll(selector) : $ele.append(selector);
  });
};
Cash.prototype.has = function(selector) {
  const comparator = isString(selector) ? (i2, ele2) => !!find(selector, ele2).length : (i2, ele2) => ele2.contains(selector);
...
Cash.prototype.is = function(comparator) {
  ...
  let check = false;
  this.each((i2, ele2) => {
    check = compare.call(ele2, i2, ele2);
    return !check;
  });
  return check;
};
...
Cash.prototype.not = function(comparator) {
  if (!comparator || !this[0])
    return this;
  const compare = getCompareFunction(comparator);
  return this.filter((i2, ele2) => !compare.call(ele2, i2, ele2));
};
Cash.prototype.parent = function(comparator) {
  return filtered(cash(unique(pluck(this, "parentNode"))), comparator);
};
Cash.prototype.index = function(selector) {
  const child = selector ? cash(selector)[0] : this[0], collection2 = selector ? this : cash(child).parent().children();
  return indexOf.call(collection2, child);
};
...
Cash.prototype.siblings = function(comparator) {
  const result = [];
  this.each((i2, ele2) => {
    push.apply(result, cash(ele2).parent().children((ci, child) => child !== ele2));
  });
  return filtered(cash(unique(result)), comparator);
};
...
var ResizePanel = function(_React$Component) {
  _inherits(ResizePanel2, _React$Component);
  function ResizePanel2(props) {
    var _this;
    _classCallCheck(this, ResizePanel2);
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ResizePanel2).call(this, props));
  ...
  _createClass(ResizePanel2, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var content = this.contentRef.current;
      var actualContent = content.children[0];
      var initialSize = this.isHorizontal() ? cash(actualContent).outerWidth(true) : cash(actualContent).outerHeight(true);
      this.setState({
        size: initialSize
      });
      this.validateSize();
    ...
    value: function render() {
      ...
      var content = [import_react.default.createElement("div", {
        ...
        style: contentStyle
      }, import_react.default.Children.only(this.props.children))];
      var handle = import_react.default.createElement(DraggableCore, _extends({
        key: "handle"
      }, dragHandlers), import_react.default.createElement("div", {
...
var index_esm_default = ResizePanel;
export {
  index_esm_default as default
};
/*! Bundled license information:

react-resize-panel/dist/index.esm.js:
  (*
  object-assign
  (c) Sindre Sorhus
  @license MIT
  ...
  *)
*/
//# sourceMappingURL=react-resize-panel.js.map
